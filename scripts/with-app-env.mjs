...
function main(argv) {
  ...
  // npm exposes local CLIs as `.cmd` shims on Windows. Running through the
  // platform shell lets commands such as `vite` resolve to those shims, while
  // preserving direct execution on POSIX hosts.
